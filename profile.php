...
<div class="card2" style="display: flex; flex-direction: column; gap: 25px; ">
    ...
    <h1 style=""><svg xmlns="http://www.w3.org/2000/svg" width="100" height="50" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
...
<div class="card2" style="display: flex; flex-direction: column; gap: 25px;  ">
    <?php while ($row = mysqli_fetch_assoc($post_query)) : ?>
        <div style="display: flex; flex-direction: column; border: 3px solid black; padding: 16px; border-radius: 6px; max-width: 400px; margin: 0 auto; background: white;">
  ...
  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
                ...
                <a class="text" 1 href="./detail-post.php?foto_id=<?= $row['foto_id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-heart-fill" viewBox="0 0 16 16">
